...
use crate::pikachuvolleyball::{Pokeball, ScoreBoard, ScoreText, ARENA_HEIGHT, ARENA_WIDTH};
...
impl<'s> System<'s> for WinnerSystem {
    ...
    fn run(
        &mut self,
        (mut pokeballs, mut locals, mut scores, score_text, mut ui_text): Self::SystemData,
    ) {
